...
const Product = () => {
  ...
  const images = [
    ...
    "https://images.unsplash.com/photo-1588731234159-8b9963143fca?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80",
  ];
  return (
    <div className="product">
      ...
      <div className="right">
        <h1>Title</h1>
        <span className="prices">₹400</span>
        <p>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Enim, amet
          consectetur qui sunt quasi eos asperiores corrupti ab nesciunt ad eum.
          Repellendus, sunt harum consequatur sit ut saepe magni magnam.
        </p>
